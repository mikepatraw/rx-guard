...
assert.match(systemPrompt, /PO_CURRENT_PATIENT_HIGH_RISK/);
...
assert.doesNotMatch(systemPrompt, /Sheila Bankston/);
...
assert.match(chatTestPrompt, /PDMP overlay case: PO_CURRENT_PATIENT_HIGH_RISK/);
