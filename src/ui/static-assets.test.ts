...
assert.match(html, /PreSignRx – Controlled Substance Risk Analysis/);
...
assert.ok(js.includes('rerunRxguardBtn'));
...
assert.doesNotMatch(js, /DOB:|02\/03\/1980|05\/12\/1984/);
